---
title: 使用SOLIDWORKS API管理文档用户偏好
caption: 文档选项
description: 一系列文章和示例，演示如何使用SOLIDWORKS API控制文档选项（用户偏好）
labels: [文档, 偏好, 选项]
---
要管理SOLIDWORKS零件、装配或绘图的用户偏好（选项），需要使用以下SOLIDWORKS API之一：
...
本节包含使用SOLIDWORKS API自动化文档用户偏好的示例和宏。